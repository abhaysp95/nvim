...
function! g:BuffetSetCustomColors()
	hi! BuffetCurrentBuffer guibg=#458588 guifg=background gui=bold
	hi! BuffetActiveBuffer guibg=255 guifg=foreground
	hi! BuffetBuffer guibg=255 guifg=#a5a5a5
	hi! BuffetTab guibg=255 guifg=#458588 gui=bold
	hi! BuffetTrunc guibg=255 guifg=#458588 gui=bold
endfunction
