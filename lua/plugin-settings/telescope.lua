...
require('telescope').setup {
	defaults = {
		...
		qflist_previwer = require('telescope.previewers').vim_buffer_qflist.new,
	...
	extensions = {
		fzy_native = {
			overridde_generic_sorter = false,
...
M.search_dotfiles = function()
	require("telescope.builtin").find_files({
			prompt_title = "< Config > ",
			cwd = "$HOME/Downloads/git-materials/my_repos/my-config-files/",
		})
end
