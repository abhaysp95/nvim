...
hi NonText      guifg=#3a6a20       guibg=NONE          gui=bold
...
hi DiffAdd      guifg=#ffffff       guibg=background       gui=NONE
            \   ctermfg=white       ctermbg=darkblue    cterm=NONE
hi DiffChange   guifg=#000000       guibg=background       gui=NONE
            \   ctermfg=black       ctermbg=darkmagenta cterm=NONE
hi DiffDelete   guifg=#000000       guibg=background       gui=bold
...
hi FoldColumn   guifg=#c8bcb9       guibg=background       gui=bold
            \   ctermfg=lightgray   ctermbg=darkgray    cterm=NONE
hi SignColumn   guifg=#c8bcb9       guibg=background       gui=bold
            \   ctermfg=lightgray   ctermbg=darkgray    cterm=NONE
...
hi StatusLine   guifg=foreground       guibg=background       gui=bold
...
hi VertSplit    guifg=foreground       guibg=background       gui=NONE
            \   ctermfg=white       ctermbg=white       cterm=NONE

hi TabLine      guifg=foreground       guibg=#c2bfa5       gui=NONE
